...
# TODO: Need to wait for skywalking-infra-e2e support to be installed by `go install` command
# E2E = $(shell pwd)/bin/e2e
# skywalking-e2e: ## Download skywalking-e2e locally if necessary.
#	 $(call go-get-tool,$(E2E),github.com/apache/skywalking-infra-e2e@v1.1.0)
