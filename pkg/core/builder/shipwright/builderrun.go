...
func Registry(rm meta.RESTMapper) []client.Object {
	...
	if _, err := rm.ResourcesFor(schema.GroupVersionResource{Group: "shipwright.io", Version: "v1alpha1", Resource: "buildstrategies"}); err == nil {
		objs = append(objs, &shipwrightv1alpha1.BuildStrategy{})
	}

	if _, err := rm.ResourcesFor(schema.GroupVersionResource{Group: "shipwright.io", Version: "v1alpha1", Resource: "clusterbuildstrategies"}); err == nil {
		objs = append(objs, &shipwrightv1alpha1.ClusterBuildStrategy{})
	}
