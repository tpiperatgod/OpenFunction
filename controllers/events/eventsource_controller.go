...
const (
	eventSourceHandlerImage = "openfunction/eventsource-handler:latest"
)
...
func (r *EventSourceReconciler) createOrUpdateEventSource(ctx context.Context, log logr.Logger, eventSource *ofevent.EventSource) error {
	...
	if eventSource.Spec.LogVerboseLevel != nil {
		r.EventSourceConfig.LogLevel = *eventSource.Spec.LogVerboseLevel
	}
